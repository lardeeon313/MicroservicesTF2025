...
{
    /// <summary>
    /// Consumidor para eventos de resolución de incidentes en pedidos.
    /// </summary>
    public class OrderResolveIncidentConsumer : BackgroundService
    {
        ...
        private const string QUEUE_NAME = "sales_order_resolve_incident_queue";
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.ReceivedAsync += async (model, ea) =>
            {
                ...
                try
                {
                    ...
                    if (evento is not null)
                    {
                        ...
                        if (order != null)
                        {
                            ...
                            order.ModifiedStatusDate = evento.ResolveIncidentAt;
                            ...
                            _logger.LogInformation("📦 Order {OrderId} marked as Resolve Incident.", order.Id);
                ...
                {
                    _logger.LogError(ex, "❌ Error processing Resolve Incident order event {OrderId}", evento?.SalesOrderId ?? 0);
                    await _channel.BasicNackAsync(ea.DeliveryTag, false, requeue: false);
                }
            };
