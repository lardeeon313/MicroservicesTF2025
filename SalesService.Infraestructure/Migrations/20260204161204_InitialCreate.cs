    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPaymentTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerPaymentTypes_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderSatisfactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderSatisfactions_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderSatisfactionTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderSatisfactionTokens_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPaymentTypes_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderSatisfactions_OrderId",
                table: "OrderSatisfactions",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderSatisfactionTokens_OrderId",
                table: "OrderSatisfactionTokens",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderSatisfactionTokens_Token",
                table: "OrderSatisfactionTokens",
                column: "Token",
                unique: true);
