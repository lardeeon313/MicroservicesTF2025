...
import type { DepotOrderItemsReportedDto } from '../../types/Missing';
...
const MissingCount : React.FC<MissingCountProps> = ({ count }) => {
    
    //const totalMissingReports = order.missings.length;
