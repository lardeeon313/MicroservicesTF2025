...
namespace DepotService.Application.Services.IdentityServiceClient
{
    public class IdentityServiceClient : IIdentityServiceClient
    {
        ...
        private const string SalesStaffsEndpoint = "operators";
        ...
        public async Task<List<DepotOperatorsDto>> GetUserWithRoleOperator()
        {
            ...
            var result = JsonSerializer.Deserialize<List<DepotOperatorsDto>>(json, _jsonOptions);
