        ...
        <table className="w-full">
          <thead>
            <tr className="text-xs font-medium text-gray-600 uppercase tracking-wider border-b border-gray-200">
              <th className="px-6 py-3 text-left bg-gray-50 w-[100px]">PEDIDO ID</th>
              <th className="px-6 py-4 text-left bg-white">CLIENTE</th>
              <th className="px-6 py-4 text-left bg-white">FECHA MODIFICACIÓN</th>
              <th className="px-6 py-4 text-left bg-white">ESTADO</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr className="bg-gray-50 border-t border-gray-200">
              <td colSpan={4} className="px-6 py-4">
                <div className="text-sm text-gray-600">
                  ...
                  {filteredOrders.length > 1 && <span className="ml-2 text-xs">• Cancelados, emitidos o pendientes</span>}
                </div>
              </td>
