import { AdminCustomerSatisfactionReportItem } from "../../../../admin/pages/AdminDashboardFeatures/ReportsSales/Types/CustomerSatisfactionType";
import { CustomerSatisfactionLevelBadge } from "../../../../admin/pages/AdminDashboardFeatures/ReportsSales/Types/CustomerSatisfactionLevelBadge";

interface Props {
  data: AdminCustomerSatisfactionReportItem[];
}

export const SalesCustomerSatisfactionTable: React.FC<Props> = ({ data }) => {
  if (data.length === 0) {
    return (
