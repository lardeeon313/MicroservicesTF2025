...
import { CustomerStatusReportDto } from "../../../../admin/pages/AdminDashboardFeatures/ReportsSales/Types/CustomerStatusReportType";
...
export const CustomerStatusReportTable: React.FC<Props> = ({ data }) => {
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
        ...
        <p className="text-gray-600 text-lg">
          No hay clientes con dicho estado
        </p>
            ...
            <tr className="bg-gray-50 border-t border-gray-200">
              <td className="px-6 py-4">
                <div className="text-sm text-gray-600">
                  ...
                  {data.length === 1 ? "cliente" : "clientes"}
                </div>
              </td>
