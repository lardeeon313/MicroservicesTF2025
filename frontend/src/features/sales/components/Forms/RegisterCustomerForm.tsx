...
import { User, Mail, Phone, MapPin, CreditCard, Plus, Trash2, UserPlus, AlertCircle } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">
                Selecciona las formas de pago disponibles para el cliente <span className="text-red-600">*</span>
              </label>
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        className="w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-2 focus:ring-red-500 focus:outline-none"
                      />
