...
import { useModifiedCanceledOrdersReport } from "./SalesHocks/ModifiedCanceledOrdersHock";
import { ModifiedCanceledOrder , ModifiedCanceledOrderStatus  , ModifiedCanceledFilters} from "../../../admin/pages/AdminDashboardFeatures/ReportsSales/Types/ModifiedCanceledReportType";
...
export default function ModifiedCanceledOrdersPage() {
  ...
  const {
    ...
    totalPages,
    refetch,
  } = useModifiedCanceledOrdersReport(page, pageSize, filters);
