...
import { CustomerReportRow } from "../../SalesPages/useSalesPaymentTypeReport";
...
const CustomerReportPaymentTable: React.FC<Props> = ({ data, loading }) => {
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600">No se obtuvieron clientes segun los filtros consultados</p>
        </div>
      </div>
    );
  }
        ...
        <tbody className="divide-y divide-gray-100">
          {data.map((row) => (
            ...
            >
              ...
              {/* Nombre + avatar redondo como en tu imagen */}
              ...
              <td className="px-4 py-3 text-gray-700">
                {row.address || <span className="text-gray-400">Sin dirección</span>}
              </td>
            </tr>
          ))}
        </tbody>
...
export default CustomerReportPaymentTable;
