...
export default function CustomerInactiveReportFilter({
  ...
  <div className="bg-white border border-gray-200 shadow-md rounded-xl p-6 w-full flex flex-col">
    ...
    <div className="flex flex-col gap-3 w-64 ml-auto mt-6">

      <div className="px-4 py-3 rounded-lg bg-green-100 text-green-800 shadow-sm">
      ...
      <div className="px-4 py-3 rounded-lg bg-yellow-100 text-yellow-800 shadow-sm">
        <div className="text-sm font-semibold">Clientes inactivos</div>
        <div className="text-xs mt-0.5 leading-tight">
          Son clientes que no realizaron pedidos todavia.
        </div>
      </div>
