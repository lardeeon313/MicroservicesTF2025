...
import { CustomerStatusReportDto,GetCustomerStatusReportRequest,PagedResult } from '../../../../admin/pages/AdminDashboardFeatures/ReportsSales/Types/CustomerStatusReportType';
import API from '../../../../../api/axios';

export const UseCustomerStatusReport = (
