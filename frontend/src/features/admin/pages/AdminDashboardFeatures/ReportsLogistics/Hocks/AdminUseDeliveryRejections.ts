...
import { DeliveryRejectionReport,PagedResponse } from "../../../../../verification/types/Report";
import { RejectionReportFilters } from "../../../../../verification/types/FilterReports/FilterReportsEntity";

export const AdminUseDeliveryRejections = (filters: RejectionReportFilters & { pageNumber?: number; pageSize?: number }) => {
