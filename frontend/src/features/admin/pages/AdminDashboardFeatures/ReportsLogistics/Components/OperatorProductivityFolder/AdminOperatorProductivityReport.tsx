...
export const AdminOperatorProductivityTable: React.FC<Props> = ({ data }) => {
      ...
      <table className="w-full border-collapse text-left">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Pedidos entregados</th>
            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Asignaciones canceladas</th>
            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Pedidos asignados</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((op) => (
            <tr key={op.operatorId} className="hover:bg-gray-50 transition-colors duration-200">
              ...
              <td className="px-6 py-4 text-sm font-medium text-gray-900">{op.teamName}</td>
