...
const AdminDeliveryRejectionsTable: React.FC<Props> = ({ data }) => {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600">
            No se registraron pedidos rechazados al momento de generar el reporte.
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-between bg-gradient-to-r from-red-100 to-red-200 px-6 py-3 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <h2 className="text-lg font-semibold text-gray-800">
            Tabla Principal - Rechazos de Entrega
          </h2>
        </div>
...
export default AdminDeliveryRejectionsTable;
