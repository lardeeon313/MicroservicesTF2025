...
import { DepotTeamPerformanceDto } from "../../../../../../depot/pages/reports/Depot/DepotHocks/useTeamProdictivity";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600">
              No hay datos de los operarios para los filtros seleccionados
            </p>
          </div>
        </div>
      );
