...
import { OrderProcessingTime } from "../../../../../depot/pages/reports/Depot/DepotHocks/useAverageTimeOrder";

interface Props {
  data: OrderProcessingTime[];
}

const AdminProcessingTimeTable: React.FC<Props> = ({ data }) => {
...
export default AdminProcessingTimeTable;