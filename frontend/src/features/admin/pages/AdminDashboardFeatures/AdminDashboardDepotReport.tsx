...
const cards = [
    //reportes de deposito
  {
    ...
    link: "/depot/reports/admin/averageTimeOrder",
  },
  {
    ...
    link: "/depot/reports/admin/dailyMissing",
  },
  {
    ...
    link: "/depot/reports/admin/orderCompletedDay",
  },
  {
    ...
    link: "/depot/reports/admin/teamProdictivity",
  },
];

export const AdminDashboardDepotReportPage = () => {
  return (
