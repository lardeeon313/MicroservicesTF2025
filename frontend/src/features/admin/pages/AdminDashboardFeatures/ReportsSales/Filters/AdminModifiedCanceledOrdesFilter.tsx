...
import { ModifiedFilterStatus } from "../Types/ModifiedCanceledReportType";
...
type Props = {
  ...
  dateToDraft: string;
  statusDraft: ModifiedFilterStatus;
  onNameDraftChange: (value: string) => void;
  onDateFromDraftChange: (value: string) => void;
  onDateToDraftChange: (value: string) => void;
  onStatusDraftChange: (value: ModifiedFilterStatus) => void;
  onBuscar: () => void;
  onLimpiar: () => void;
};

const AdminModifiedCanceledOrdersFilter: React.FC<Props> = ({
  nameDraft,
  dateFromDraft,
  dateToDraft,
  statusDraft,
    ...
    <div className="bg-gray-50 border border-gray-200 shadow-sm rounded-xl p-6 w-full mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <select
            value={statusDraft}
            onChange={(e) => onStatusDraftChange(e.target.value as ModifiedFilterStatus)}
            className="border border-gray-300 rounded-lg px-3 py-2"
          >
...
export default AdminModifiedCanceledOrdersFilter;
