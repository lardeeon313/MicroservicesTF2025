...
export const AdminCustomerStatusReportPage = () => {
  ...
  const {
    ...
    error,
    refetch, 
  } = AdminUseCustomerStatusReport(requestParams);
  ...
  return (
    <div className="container m-0 pt-10 min-w-full min-h-full">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Filtros */}
        <div className="mb-4">
          <AdminCustomerStatusReportFilter onSearch={handleSearch} />
        </div>
        ...
        {data && !loading && (
          <>
            <AdminCustomerStatusReportTable data={data.items} />
            ...
            {showGraph && (
              <div className="mt-8">
                <AdminGraphCustomerStatus customers={data.items} />
              </div>
            )}
          </>
        )}
