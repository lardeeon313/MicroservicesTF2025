...
import { AdminCustomerReportHock } from "../Hocks/AdminCustomerReportHock";
import AdminCustomerReportTable from "../Components/AdminCustomerReportTable";
import { AdminCustomerReportFilter } from "../Filters/AdminCustomerReportFilter";
import AdminGraphCustomerReport from "../Graphs/AdminGraphCustomerReport";
...
export default function AdminCustomerReportPage() {
  ...
  const { data, loading, fetchReport } = AdminCustomerReportHock();
    ...
    <div className="container m-0 pt-10 min-w-full min-h-full">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {showGraph && items.length > 0 && (
          <div className="mt-8">
            <AdminGraphCustomerReport data={items} />
          </div>
        )}
