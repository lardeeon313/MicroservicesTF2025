...
const HomePage = () => {
  return (
    <div className="bg-white py-2 sm:py-32 flex justify-center min-h-full">
      <div className="max-w-5xl lg:max-w-6xl lg:px-8 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[500px]">
            ...
            <div className="text-center lg:text-right lg:border-r-2 lg:border-gray-200 px-8 py-12 lg:px-12 lg:py-16 bg-gradient-to-br from-white to-gray-50 relative">
              ...
              <div className="relative z-10">
                ...
                <div className="inline-flex items-center px-4 py-2 bg-red-50 border border-red-100 rounded-full mb-4">
                  <h2 className="text-sm font-semibold text-red-600">Sistema de Gestión de Pedidos</h2>
                </div>
                
                <h1 className="mt-4 text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl mb-6 leading-tight">
                  Distribuidora Verona
                </h1>
                
                <p className="mt-6 text-lg text-gray-700 leading-relaxed max-w-lg mx-auto lg:mx-0 lg:ml-auto">
            ...
            <div className="px-8 py-12 lg:px-12 lg:py-16 bg-white">
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:border-red-200 hover:bg-red-50/20 transition-all duration-300 group">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:border-gray-300 hover:bg-gray-100/50 transition-all duration-300 group">
                  <div className="flex items-center justify-between mb-4">
