...
export const AssignOperatorToTeam = ({ isOpen, onClose, teamId, onRefetch }: AssignOperatorToTeamProps) => {
    ...
    }, [isOpen, fetchAvailableOperators]);
    ...
    const handleOperatorSelect = (operator: OperatorDto) => {
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <Combobox
                                            ...
                                            onChange={(operator) => operator && handleOperatorSelect(operator)}
                                        >
