...
export default function OrderCompletedDayFilter({
  ...
  return (
    <div className="flex items-center gap-4 mb-6 bg-white shadow-md p-4 rounded-xl">
      ...
      <div className="flex flex-col">
        <label className="text-sm text-gray-600 mb-1">Periodo:</label>
        <select
        ...
        >
          ...
          <option value="half">Quincena</option>
      ...
      <div className="flex flex-col w-full">
        <label className="text-sm text-gray-600 mb-1">Nombre de cliente:</label>
          <input
            type="text"
