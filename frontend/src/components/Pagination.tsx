...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="bg-white py-2 text-center">
      <div className="inline-flex gap-1 rounded-full border border-gray-300">
        <ul className="flex items-center gap-1">
          ...
          <li>
            <button
              ...
              className="flex h-10 min-w-10 items-center justify-center rounded-full px-2 text-gray-700 hover:bg-gray-200 disabled:opacity-40"
            >
              ←
            </button>
          </li>
