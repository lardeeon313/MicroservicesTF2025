...
{
    public class UpdateMissingOrderCommandHandler(IOrderRepository repository) : IUpdateMissingOrderCommandHandler
    {
        private readonly IOrderRepository _orderRepository = repository;
        public async Task<OrderDto?> HandleAsync(UpdateMissingOrderCommand command)
        {
            ...
            existingOrder.Status = OrderStatus.PendingReissued;
