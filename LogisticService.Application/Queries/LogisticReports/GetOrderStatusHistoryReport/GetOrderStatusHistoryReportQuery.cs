...
namespace LogisticService.Application.Queries.LogisticReports.GetOrderStatusHistoryReport
{
    public class GetOrderStatusHistoryReportQuery
    {
        ...
        public GetOrderStatusHistoryReportQuery(DateTime? startDate, DateTime? endDate, Guid? operatorId1, OrderStatus? oldStatus, OrderStatus? newStatus, Guid? operatorId2)
        {
            StartDate = startDate;
            EndDate = endDate;
