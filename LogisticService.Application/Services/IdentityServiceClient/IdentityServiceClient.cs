...
namespace LogisticService.Application.Services.IdentityServiceClient
{
    public class IdentityServiceClient : IIdentityServiceClient
    {
        ...
        public async Task<List<DeliveryOperatorDto>> GetUserWithRoleDeliveryOperator()
        {
            ...
            var response = await _httpClient.GetAsync("deliveryoperators");
            ...
            // Leer el contenido de la respuesta y deserializarlo a una lista de DepotOperatorsDto
            var json = await response.Content.ReadAsStringAsync();
            var result = JsonSerializer.Deserialize<List<DeliveryOperatorDto>>(json, _jsonOptions);
            ...
            // Retornar la lista de DepotOperatorsDto
            return result;
        }
    }
}
